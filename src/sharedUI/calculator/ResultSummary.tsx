...
export interface ResultSummaryItem { id: string; label: string; value: ReactNode; hint?: ReactNode; className?: string; }
export interface ResultSummaryProps { items: ResultSummaryItem[]; columns?: 1 | 2 | 3 | 4; title?: ReactNode; footer?: ReactNode; className?: string; }

const columnsClass = { 1: "grid-cols-1", 2: "grid-cols-1 sm:grid-cols-2", 3: "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3", 4: "grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" } as const;
