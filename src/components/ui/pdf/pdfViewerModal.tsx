...
export default function PdfViewerModal({
  ...
  return (
    ...
    >
      <div 
        ref={modalRef}
        className="relative flex h-full w-full flex-col overflow-hidden bg-card shadow-2xl sm:h-[95vh] sm:w-[96vw] md:h-[92vh] md:w-[90vw] lg:h-[90vh] lg:w-[85vw] xl:h-[88vh] xl:w-[80vw] 2xl:h-[86vh] 2xl:w-[75vw] rounded-none sm:rounded-3xl border border-border sm:border-border-strong"
      >
        {/* Animated gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-transparent to-purple-500/5 pointer-events-none" />

        {/* Header */}
        <header className="relative flex flex-col items-center justify-between border-b border-border bg-surface-raised px-4 py-3 sm:px-6 sm:py-4">
