...
//   const findOrCreate = (nodes: ZipTreeNode[], name: string, path: string, isFolder: boolean) => {
...
//       const node = findOrCreate(current.children, part, path, isFolder);
...
//         } else {
//           files += 1;
//           if ((n.type || "").toLowerCase() === "pdf" && n.pages) pdfPages += n.pages;
//         }
//       }
//     };
...
//                 <div className="mt-6 mx-auto w-full max-w-[200px]">
