...
export async function DownloadCard({
  ...
  return (
    <div className="rounded-2xl border border-border bg-gradient-to-b from-slate-100/60 to-slate-200/30 dark:from-gray-950/60 dark:to-gray-900/30 p-5 space-y-4">
