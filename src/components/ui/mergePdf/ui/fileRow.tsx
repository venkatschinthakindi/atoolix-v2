...
export function FileRow({
  ...
  const displayPreview = fullpreview.length > 60
    ...
    : fullpreview;
  return (
    <div className="rounded-3xl border border-border bg-card p-4 backdrop-blur-md transition hover:border-blue-400 dark:hover:border-blue-400/25 hover:bg-surface-raised">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-blue-300 dark:border-blue-400/15 bg-white/90 ">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 rounded-2xl border border-border bg-card px-3 py-2 text-xs text-foreground transition hover:bg-red-100 dark:hover:bg-red-500/10 hover:text-status-critical"
          >
      ...
      <div className="mt-4 space-y-2">
        ...
        <input
          className="w-full rounded-2xl border border-border bg-popover px-3 py-2.5 text-sm text-foreground outline-none transition placeholder:text-foreground-faint focus:border-blue-300 dark:border-blue-400/40 focus:ring-2 focus:ring-blue-400/15"
          value={item.input}
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <span
            title={fullpreview}
            className="cursor-help rounded-full border border-blue-300 dark:border-blue-400/15 bg-blue-100 dark:bg-blue-400/10 px-2.5 py-1 text-[11px] text-blue-700 dark:text-blue-100"
          >
            {displayPreview}
          </span>
        </div>
