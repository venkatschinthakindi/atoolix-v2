export default function ImageToPdfSeoContent() {
  const faqItems = [
    {
      ...
      a: "Upload one or more JPG, JPEG, PNG, or WEBP images, reorder them if needed, choose your PDF settings such as page size, orientation, and margin, then generate and download the PDF instantly in your browser.",
    },
    {
      q: "Can I convert multiple images into one PDF?",
      a: "Yes. You can upload multiple images and combine them into a single PDF document in the exact order you want.",
    },
    {
      q: "Is this image to PDF converter private?",
      a: "Yes. Your files remain on your device during conversion and are not uploaded to a server."
    },
    {
      q: "What image formats are supported?",
      a: "The tool supports JPG, JPEG, PNG, WEBP, and other browser-supported image types allowed in your configuration.",
    },
    {
    ...
    {
        q: "Can I convert photos from my phone into a PDF?",
        a: "Yes. You can upload images stored on your phone and convert them into a PDF directly from your mobile browser."
    },
    {
        q: "Can I create one PDF with one image per page?",
    ...
    {
    q: "Is there a limit to the number of images I can convert?",
    a: "The practical limit depends on your browser and available device memory. Most modern devices can comfortably convert multiple images into a single PDF."
    }
  ];
  ...
  const howToSteps = [
    {
      ...
      desc: "Add one or more JPG, JPEG, PNG, or WEBP images using drag and drop or the file picker.",
      icon: "📤",
    },
    {
      title: "Reorder Files",
  ...
  const coreFeatures = [
    {
      ...
      desc: "Convert JPG, JPEG, PNG, and WEBP images into a clean PDF document online.",
      icon: "🖼️",
    },
    {
      title: "Multiple Image Support",
      desc: "Combine several images into one PDF in a chosen order.",
      icon: "📚",
    },
    {
  ...
  const audiences = [
    {
      title: "Designers",
      desc: "Convert mockups and image sets into printable PDFs.",
      icon: "🎨",
    },
    {
      title: "Students",
    ...
    {
      title: "Office Users",
      desc: "Combine image files into a professional PDF for sharing.",
      icon: "💼",
    },
    {
      title: "Content Creators",
      desc: "Package image exports into a neat PDF archive.",
      icon: "🧩",
    },
    {
      title: "Mobile Users",
    ...
    },
    {
      ...
      desc: "Keep image conversion local and avoid server uploads.",
      icon: "🛡️",
    },
  ];
...
<section aria-labelledby="intro-heading">
        ...
        <p className="mt-3 text-sm leading-relaxed text-white/65 sm:text-base">
          ...
          Upload multiple images, reorder them, choose page size and orientation,
          adjust margins, and generate a clean PDF without uploading files to a
          server.
        </p>
        <p className="mt-4 text-sm leading-relaxed text-white/65 sm:text-base">
          This tool is designed for users who want a fast image to PDF converter
...
<p className="mb-5 text-sm leading-relaxed text-white/65 sm:text-base">
        The converter accepts the most common image formats used on phones,
        cameras, screenshots, and graphic design software, then combines them
        into a standard PDF document that can be viewed, printed, or shared
        almost anywhere.
        </p>
  </div>
</section>
...
>
  <h2
    ...
    className="mb-4 text-xl font-bold tracking-tight text-white sm:text-2xl"
  >
    Common Ways People Use an Image to PDF Converter
  </h2>

  <div className="grid gap-4 md:grid-cols-2">
    <ul className="space-y-3 text-sm text-white/70">
      <li>• Combine scanned documents into one PDF</li>
    ...
    <ul className="space-y-3 text-sm text-white/70">
      ...
      <li>• Send multiple images as one PDF attachment</li>
      ...
      >
        <h2
          ...
          className="mb-4 text-xl font-bold tracking-tight text-white sm:text-2xl"
        >
          Why Use This Image to PDF Converter Online?
        </h2>
        <p className="text-sm leading-relaxed text-white/65 sm:text-base">
      ...
      >
        ...
        <p className="text-sm leading-relaxed text-white/65 sm:text-base">
          When you upload images, the tool reads them directly in your browser and
...
<section
  aria-labelledby="why-pdf-heading"
>
  <h2
    id="why-pdf-heading"
    className="mb-4 text-xl font-bold tracking-tight text-white sm:text-2xl"
  ...
  <ul className="space-y-3 text-sm leading-relaxed text-white/70">
    <li>• Keep multiple images together in a single document.</li>
    ...
    <li>• Create professional documents from image collections.</li>
      ...
      >
        ...
        <ul className="space-y-3 text-sm leading-relaxed text-white/65">
          <li>Convert JPG, JPEG, PNG, and WEBP images into a single PDF quickly.</li>
      ...
      >
        ...
        <p className="text-sm leading-relaxed text-white/65 sm:text-base">
            The Image to PDF Converter makes it easy to convert JPG, JPEG, PNG, and WEBP
            images into a single PDF directly in your browser. Whether you're preparing
            ...
            and instant PDF generation without requiring uploads to external servers.
            </p>

            <p className="mt-4 text-sm leading-relaxed text-white/65 sm:text-base">
            With support for multiple images, customizable layouts, responsive design,
