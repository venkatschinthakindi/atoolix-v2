      ...
      {open && (
        <div className="px-5 pb-4 pt-1 text-xs text-white/50 leading-relaxed space-y-2 border-t border-white/10">
          ...
          <p className="text-white/40">
            These are standard mathematical estimates. Actual
            financial products may include fees, taxes, timing rules,
            or different compounding methods.
          </p>
        </div>
      )}
    </div>
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2">
              <div className="relative">
                <div className="absolute inset-0 bg-violet-400/30 blur-md rounded-full animate-pulse" />

                <div className="relative inline-flex items-center gap-2 rounded-full border border-violet-400/30 bg-violet-400/15 px-3 py-1.5 text-xs font-medium text-violet-200">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base sm:text-lg text-white/70 leading-relaxed max-w-xl">
                Calculate how your investment grows when interest
                is added back to the principal over time.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <div className="text-xs text-white/50 mt-1">
                  Export your calculation instantly
                </div>
              </div>
