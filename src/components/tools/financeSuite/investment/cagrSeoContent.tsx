...
const faqItems = [
  ...
  },
  {
    ...
    a: "Yes, CAGR can be mathematically annualized over a period shorter than one year. However, short-period annualization should be interpreted carefully because small changes can produce large annualized rates.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. The measurement period can be converted appropriately into years before applying the CAGR formula.",
  },
  {
