      ...
      >
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <p className="text-xs leading-7 text-white/65 sm:text-sm">
            SIP investments are a common use case for XIRR because contributions
            occur repeatedly over time. Each SIP installment has a different
            investment date, meaning each installment has a different period of
          ...
          <p className="mt-4 text-xs leading-7 text-white/65 sm:text-sm">
            ...
            entered as negative cash flows using their actual transaction dates,
            while the current investment value can be entered as a positive
            cash flow on the valuation date.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <article className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <ul className="mt-3 space-y-2 text-xs leading-6 text-white/65">
              <li>
                You have a beginning investment value.
              </li>
              <li>
                You have an ending investment value.
              </li>
              <li>
                There are no material intermediate cash flows.
              </li>
              <li>
                You want a simple annualized growth rate.
              </li>
            </ul>
          </article>
          ...
          <article className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <ul className="mt-3 space-y-2 text-xs leading-6 text-white/65">
              <li>
                There are multiple investments.
              </li>
              <li>
                Contributions occur on different dates.
              </li>
              <li>
                Withdrawals or redemptions occur.
              </li>
              <li>
