  ...
  function onKeyDown(e: KeyboardEvent<HTMLInputElement>) {
    ...
    >
      <input
        ...
        onKeyDown={onKeyDown}
        className="w-full rounded-2xl border border-border bg-surface-sunken px-3 py-2 text-foreground outline-none focus:border-border-strong"
      />

      {open && (
        <div className="absolute z-50 mt-2 max-h-80 w-full overflow-y-auto rounded-2xl border border-border bg-popover shadow-xl scrollbar-thin">
          {filtered.length === 0 && (
