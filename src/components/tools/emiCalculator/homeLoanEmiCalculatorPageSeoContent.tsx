  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 p-4 text-white">
      ...
      <section className="space-y-4" aria-labelledby="home-loan-planning">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <h3 className="font-semibold text-white">Compare loan tenures</h3>
            <p className="mt-2 text-sm leading-7 text-white/60">A longer tenure generally lowers the monthly EMI but keeps the principal outstanding for longer. Compare a comfortable EMI with the total interest cost before choosing a repayment period.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <h3 className="font-semibold text-white">Test an interest-rate change</h3>
            <p className="mt-2 text-sm leading-7 text-white/60">Compare the repayment impact of different rates. This is useful when evaluating loan offers or understanding how a rate change could affect an existing repayment plan.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <h3 className="font-semibold text-white">Model a lump-sum prepayment</h3>
            <p className="mt-2 text-sm leading-7 text-white/60">Enter an additional principal payment and compare the resulting interest and repayment period with the original schedule.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            <h3 className="font-semibold text-white">Compare EMI versus tenure reduction</h3>
            <p className="mt-2 text-sm leading-7 text-white/60">After a prepayment, reducing the future EMI can improve monthly cash flow, while keeping the EMI higher can generally repay principal sooner. The lender's rules determine which option is available.</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4" aria-labelledby="home-loan-formula">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5 text-sm leading-7 text-white/65">
          EMI = P × r × (1 + r)^n ÷ ((1 + r)^n − 1), where P is principal, r is the monthly interest rate, and n is the number of monthly payments. Interest is calculated on the outstanding balance rather than the original principal throughout the entire tenure.
        </div>
      </section>
      ...
      <section className="space-y-4" aria-labelledby="home-loan-faq">
        ...
        <div className="space-y-4 text-sm leading-7 text-white/65">
          ...
          <div><h3 className="font-semibold text-white">Should I reduce EMI or tenure after a prepayment?</h3><p>Keeping the EMI similar and shortening the tenure can increase interest savings, while reducing EMI provides more monthly cash-flow flexibility. Your lender's terms determine the available options.</p></div>
          <div><h3 className="font-semibold text-white">Will this calculator exactly match my bank's schedule?</h3><p>Not necessarily. The calculator provides an estimate from your inputs. Fees, insurance, taxes, rate changes, rounding, disbursement timing, and lender-specific rules can change the final repayment schedule.</p></div>
        </div>
      </section>
