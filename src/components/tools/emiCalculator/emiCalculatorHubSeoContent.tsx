    ...
    <div className="mx-auto max-w-6xl space-y-8 p-4 text-white">
      ...
      <section aria-labelledby="emi-types" className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <a href="/tools/calculator/home-loan-emi-calculator" className="rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 transition">
            <h3 className="font-semibold">Home Loan EMI Calculator</h3>
            <p className="mt-2 text-sm text-white/55">Calculate housing-loan EMI and compare prepayment, interest, and tenure scenarios.</p>
          </a>
          <a href="/tools/calculator/car-loan-emi-calculator" className="rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 transition">
            ...
            <p className="mt-2 text-sm text-white/55">Estimate vehicle-loan EMI and compare tenure, interest, and extra-payment scenarios.</p>
          </a>
          <a href="/tools/calculator/personal-loan-emi-calculator" className="rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 transition">
            ...
            <p className="mt-2 text-sm text-white/55">Calculate unsecured-loan EMI and understand how rate and tenure affect total repayment.</p>
          </a>
        </div>
      </section>
      ...
      <section aria-labelledby="emi-formula" className="space-y-4">
        ...
        />
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5 space-y-3 text-sm text-white/65 leading-7">
      ...
      <section aria-labelledby="emi-faq" className="space-y-4">
        ...
        <div className="space-y-4 text-sm text-white/65 leading-7">
          <div><h3 className="font-semibold text-white">What does EMI mean?</h3><p>EMI means Equated Monthly Instalment. It is the scheduled monthly payment used to repay principal and interest over the loan tenure.</p></div>
          <div><h3 className="font-semibold text-white">Does a longer tenure reduce total interest?</h3><p>No. A longer tenure usually lowers the monthly EMI but increases total interest because the balance remains outstanding for longer.</p></div>
          <div><h3 className="font-semibold text-white">Can an EMI calculator show prepayment savings?</h3><p>Yes, when the calculator supports prepayments or extra monthly payments. You can compare the original schedule with a faster repayment scenario.</p></div>
          <div><h3 className="font-semibold text-white">Will the result exactly match my lender?</h3><p>Not necessarily. Lender fees, insurance, taxes, rate changes, rounding, and repayment rules can change the final schedule.</p></div>
        </div>
      </section>
    </div>
  );
