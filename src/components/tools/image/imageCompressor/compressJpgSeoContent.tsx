...
const relatedTools = [
  { name: "Compress Image", href: "/tools/image-compressor" },
  { name: "Resize JPG", href: "/tools/resize-jpg" },
  { name: "Crop JPG", href: "/tools/crop-jpg" },
  { name: "Convert to JPG", href: "/tools/convert-to-jpg" },
