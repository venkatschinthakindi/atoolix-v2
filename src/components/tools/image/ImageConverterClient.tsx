...
//     useState(config.outputFormats[0]);
...
//       <DropZone allowMultiple={false} onFiles={handleFiles} validFileTypes={getAcceptString(
//     config.inputFormats
//   )} />

//       {!outputUrl &&file && (
//         <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-gray-950/60 to-gray-900/30 p-5">
...
//             className="w-full mt-4 bg-green-600 hover:bg-green-500 p-3 rounded-xl"
//           >
//             Download Image
//           </button>
//         </div>
