export default function JpgToWebpSeoContent() {
  ...
  const relatedTools = [
    ...
    { name: "PNG to WebP Converter", href: "/tools/png-to-webp-converter" },
  ...
  const webAppJsonLd = {
    ...
    operatingSystem: "All",
    description:
      "Free browser-based JPG to WebP converter for fast, private, and web-optimized image conversion.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD",
