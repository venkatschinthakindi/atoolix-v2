    ...
    <div className="mx-auto max-w-6xl space-y-10 p-4 text-foreground sm:p-5 lg:p-6">
      ...
      <section aria-labelledby="percentage-guide" className="space-y-5">
        <div>
          ...
          <p className="mt-2 text-sm leading-7 text-foreground-secondary sm:text-base">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <article className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="mt-3 font-mono text-xs text-foreground-faint">(X ÷ 100) × Y</p>
          </article>
          ...
          <article className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="mt-3 font-mono text-xs text-foreground-faint">(X ÷ Y) × 100</p>
          </article>
          ...
          <article className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="mt-3 font-mono text-xs text-foreground-faint">((New − Original) ÷ |Original|) × 100</p>
          </article>
          ...
          <article className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="mt-3 font-mono text-xs text-foreground-faint">Value × (1 ± Percentage ÷ 100)</p>
          </article>
        </div>
      </section>
      ...
      <section aria-labelledby="how-to-use" className="space-y-4">
        ...
        <ol className="grid gap-4 md:grid-cols-3">
          <li className="rounded-2xl border border-border bg-card p-5">
            <span className="text-xs font-semibold uppercase tracking-widest text-blue-700 dark:text-blue-200">1. Choose</span>
            <h3 className="mt-2 font-semibold">Select the calculation</h3>
            <p className="mt-2 text-sm leading-6 text-foreground-secondary">Choose Percentage Calculator, Calculator, or Equation Solver.</p>
          </li>
          <li className="rounded-2xl border border-border bg-card p-5">
            <span className="text-xs font-semibold uppercase tracking-widest text-blue-700 dark:text-blue-200">2. Enter</span>
            <h3 className="mt-2 font-semibold">Provide your values</h3>
            <p className="mt-2 text-sm leading-6 text-foreground-secondary">Enter the numbers or mathematical expression required for the selected calculation.</p>
          </li>
          <li className="rounded-2xl border border-border bg-card p-5">
            <span className="text-xs font-semibold uppercase tracking-widest text-blue-700 dark:text-blue-200">3. Review</span>
            <h3 className="mt-2 font-semibold">Check the result</h3>
            <p className="mt-2 text-sm leading-6 text-foreground-secondary">Review the result and, where available, the formula used to produce it.</p>
          </li>
        </ol>
      </section>
        ...
        <div className="space-y-3">
          {faqItems.map((item) => (
            <details key={item.q} className="group rounded-2xl border border-border bg-card p-4">
              <summary className="cursor-pointer list-none font-medium text-foreground group-open:text-blue-700 dark:text-blue-200">{item.q}</summary>
              <p className="mt-3 text-sm leading-6 text-foreground-secondary">{item.a}</p>
            </details>
          ))}
        </div>
      </section>
