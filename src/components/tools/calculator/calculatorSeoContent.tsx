    ...
    <div className="mx-auto max-w-6xl space-y-10 p-4 text-white sm:p-5 lg:p-6">
      ...
      <section aria-labelledby="related-calculators" className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/tools/calculator/xirr-calculator" className="rounded-xl border border-white/10 bg-white/5 bg-white/5 px-4 py-2 text-sm text-white/80 hover:bg-white/10">XIRR Calculator</Link>
