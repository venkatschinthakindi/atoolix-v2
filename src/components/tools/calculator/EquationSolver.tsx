...
return ( <ShellCard> <SectionHeader
     icon={Calculator}
     title="Solver"
...
return ( <div className="space-y-3 text-sm text-white/80"> <DocItem label="Basics" example="12+8/2" result="16" /> <DocItem label="Percentage" example="20% of 150" result="30" /> <DocItem label="Increase" example="150 + 20%" result="180" /> <DocItem label="Decrease" example="150 - 20%" result="120" /> <DocItem
   ...
   /> <DocItem
     ...
     example="exp(1)"
     result="2.718"
   /> <DocItem label="Powers" example="pow(2,3)" result="8" /> <DocItem label="Absolute" example="abs(-5)" result="5" /> <DocItem label="Round" example="round(pi,2)" result="3.14" /> <DocItem label="Sqrt" example="sqrt(16)" result="4" /> <DocItem
     label="GCD/LCM"
     example="gcd(12,18), lcm(4,6)"
     result="6, 12"
   /> <DocItem
     label="Fraction"
     example="fraction(0.75)"
     result="3/4"
   /> <DocItem
     label="Derivative"
     example='derivative("x^2+3x","x")'
     result="2x+3"
   /> <DocItem
     label="Matrices"
     example="det([[1,2],[3,4]])"
