...
export const tools: ToolRegistryEntry[] = [
  ...
  },
  {
    ...
    // loader: () => import("@/components/tools/financeSuite/savings/simpleInterestCalculator"),
    toolShortName: "Simple Interest Calculator",
    title: "Simple Interest Calculator | Calculate Interest and Maturity",
    onPageTitle:
      "Simple Interest Calculator for Interest Earned and Maturity Value",
    description:
      "Calculate simple interest, total interest earned, and maturity value from your principal, interest rate, and investment duration with instant results and a clear growth projection.",
    icon: "Calculator",
    keywords: [
  ...
  },
  {
    ...
    // loader: () => import("@/components/tools/financeSuite/savings/compoundInterestCalculator"),
    toolShortName: "Compound Interest Calculator",
    title: "Compound Interest Calculator | Calculate Compound Growth",
    onPageTitle:
      "Compound Interest Calculator for Investment Growth and Maturity Value",
    description:
      "Calculate compound interest, total interest earned, and maturity value using your principal, annual interest rate, investment duration, and compounding frequency.",
    icon: "TrendingUp",
    keywords: [
      ...
      "compound interest maturity calculator",
      "monthly compound interest calculator",
    ],
    alternates: {
      canonical: `${siteUrl}/tools/calculator/compound-interest-calculator`,
    },
    applicationType: "WebApplication",
    applicationCategory: "Utilities",
    category: "Finance",
  ...
  },
  {
    ...
    // loader: () => import("@/components/tools/financeSuite/savings/fixedDepositCalculator"),
    toolShortName: "FD Calculator",
    title: "FD Calculator Online | Fixed Deposit Maturity & Interest",
    onPageTitle:
  ...
  },
  {
    ...
    // loader: () => import("@/components/tools/financeSuite/savings/recurringDepositCalculator"),
    toolShortName: "RD Calculator",
    title: "RD Calculator | Recurring Deposit Maturity and Interest",
    onPageTitle:
    ...
    alternates: {
      canonical: `${siteUrl}/tools/calculator/recurring-deposit-calculator`,
    },
    applicationType: "WebApplication",
    applicationCategory: "Utilities",
    category: "Finance",
  ...
  },
  {
    ...
    title: "Online Calculator – Percentage, Scientific & Equation Solver",
    toolShortName: "Online Calculator",
    onPageTitle: "Online Calculator for Percentage, Scientific Math & Equations",
    description: "Use a free online calculator for percentages, scientific math, everyday arithmetic, and supported equation solving, with algebra, trigonometry, logs, derivatives, matrices, and statistics.",
    icon: "Calculator",
    keywords: [
      "online calculator",
