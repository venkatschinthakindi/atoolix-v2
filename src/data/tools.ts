...
export const tools: ToolRegistryEntry[] = [
  ...
  // Date and Time Tools Start
  {
    ...
    title: "Timezone Converter Online | World Time Converter",
    toolShortName: "Timezone Converter",
    onPageTitle: "Timezone Converter | Compare Time Zones Worldwide",
    description: "Convert time between time zones instantly, compare world times, calculate time differences, and handle daylight saving time automatically for meetings and travel.",
    keywords: [
      "timezone converter",
