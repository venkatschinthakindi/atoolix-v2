  ...
  return (
    <div className="app-shell">
      <div className="app-container page-section pt-12">
        ...
        <main className="mx-auto mt-10 max-w-6xl space-y-10 px-4 pb-12 text-white sm:px-5 lg:px-6">
          ...
          <section aria-labelledby="image-conversion-tools" className="space-y-5">
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-white/60 sm:text-base">Use the converter that matches your source and required output format. Keeping these links together creates a clear conversion hierarchy for both visitors and search engines.</p>
            </div>
            ...
            <div className="overflow-x-auto rounded-2xl border border-white/10 bg-white/5">
              <table className="w-full min-w-[680px] text-left text-sm">
                ...
                <tbody className="text-white/70">
                  ...
                  <tr className="border-b border-white/10"><td className="px-4 py-3">Meet a 20 KB upload limit</td><td className="px-4 py-3"><Link className="text-blue-300 underline" href="/tools/image/compress-image-to-20kb">Compress Image to 20 KB</Link></td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3">Meet a 50 KB upload limit</td><td className="px-4 py-3"><Link className="text-blue-300 underline" href="/tools/image/compress-image-to-50kb">Compress Image to 50 KB</Link></td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3">Meet a 100 KB upload limit</td><td className="px-4 py-3"><Link className="text-blue-300 underline" href="/tools/image/compress-image-to-100kb">Compress Image to 100 KB</Link></td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3">Prepare a passport or ID photo</td><td className="px-4 py-3"><Link className="text-blue-300 underline" href="/tools/image/passport-photo-resizer">Passport Photo Resizer</Link></td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3">Resize a signature for an upload</td><td className="px-4 py-3"><Link className="text-blue-300 underline" href="/tools/image/resize-signature-for-upload">Signature Resizer</Link></td></tr>
          ...
          <section aria-labelledby="format-guide" className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5"><h3 className="font-semibold">JPG / JPEG</h3><p className="mt-2 text-sm leading-relaxed text-white/60">Commonly used for photographs where compact file size matters.</p></div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5"><h3 className="font-semibold">PNG</h3><p className="mt-2 text-sm leading-relaxed text-white/60">Useful for screenshots, graphics and workflows that need lossless output or transparency support.</p></div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5"><h3 className="font-semibold">WebP</h3><p className="mt-2 text-sm leading-relaxed text-white/60">Useful for modern web workflows where image delivery efficiency is important.</p></div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5"><h3 className="font-semibold">SVG</h3><p className="mt-2 text-sm leading-relaxed text-white/60">A vector format suited to logos, icons and scalable graphics; convert it to PNG or JPG when raster output is required.</p></div>
            </div>
          </section>
          ...
          <section aria-labelledby="image-faq" className="space-y-4">
            ...
            <div className="space-y-5 text-sm leading-relaxed text-white/70 sm:text-base">
              <div><h3 className="font-semibold text-white">What is the best image format for a website?</h3><p className="mt-1">It depends on the image and requirements. WebP is often useful for modern web delivery, JPG works well for many photographs, PNG is useful for graphics and transparency, and SVG is suited to scalable vector artwork.</p></div>
              <div><h3 className="font-semibold text-white">Should I convert an image or compress it?</h3><p className="mt-1">Convert when you need a different file format. Compress when the main goal is reducing file size. Some workflows benefit from both operations.</p></div>
              <div><h3 className="font-semibold text-white">Does converting an image improve its quality?</h3><p className="mt-1">Changing formats does not restore detail already lost by a lossy source format. Conversion changes how the image is encoded for a different workflow.</p></div>
            </div>
          </section>
        </main>
