            ...
            <div className="overflow-x-auto rounded-2xl border border-white/10 bg-white/5">
              <table className="w-full min-w-[680px] text-left text-sm">
                ...
                <tbody className="text-white/70">
                  ...
                  <tr className="border-b border-white/10"><td className="px-4 py-3">Meet a strict upload size</td><td className="px-4 py-3"><Link className="text-blue-300 underline" href="/tools/image/compress-image-to-50kb">Compress Image to 50 KB</Link></td></tr>
