...
export function ToolsContent() {
  ...
  const filteredKeys = Object.keys(toolRegistry).filter(toolId => toolId.toLowerCase().startsWith("calculator"));
    ...
    <div className="app-shell">
      <div className="app-container page-section">
        ...
        <div className="section-header text-center">
          <h1 className="section-title">All Calculator Tools</h1>
          <p className="section-copy mb-2">
            Explore all calculator utilities available on this site.
          </p>
        </div>
