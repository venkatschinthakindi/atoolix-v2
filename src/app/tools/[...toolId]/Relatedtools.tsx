        ...
        <nav aria-label={finalHeading} className="flex flex-wrap gap-3">
          {limitedRelatedTools.map((tool: any) => (
            <Link
              key={tool.href}
              href={tool.href}
              className="inline-flex items-center gap-2 rounded-full border border-border bg-surface-raised px-4 py-2 text-xs font-medium text-foreground-secondary transition-colors hover:border-blue-400/30 hover:bg-blue-400/20 hover:text-white"
            >
