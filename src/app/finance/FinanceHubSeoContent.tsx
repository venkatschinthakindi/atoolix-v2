    ...
    <section className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-3">
        <article className="rounded-2xl border border-slate-200 p-6">
          ...
          <p className="mt-3 text-sm leading-6">
            Estimate monthly EMI, total interest, and repayment cost for a home loan. Try different loan amounts,
            interest rates, and tenures to compare scenarios.
          </p>
        </article>
        <article className="rounded-2xl border border-slate-200 p-6">
          <h3 className="text-lg font-semibold">Savings and Investments</h3>
          <p className="mt-3 text-sm leading-6">
            Compare fixed deposits, compound growth, ROI, and other investment scenarios using your own principal,
            rate, duration, and contribution assumptions.
          </p>
        </article>
        <article className="rounded-2xl border border-slate-200 p-6">
          <h3 className="text-lg font-semibold">Retirement Planning</h3>
          <p className="mt-3 text-sm leading-6">
            Explore retirement and FIRE scenarios by changing savings, expected returns, time horizon, and target
            assumptions. Use the results for planning rather than as personalized financial advice.
          </p>
        </article>
      </div>
      ...
      <div className="mt-10 max-w-4xl">
        ...
        <ol className="mt-4 list-decimal space-y-2 pl-6 leading-7">
          ...
          <li>Enter the amount, rate, term, contribution, or other required values.</li>
