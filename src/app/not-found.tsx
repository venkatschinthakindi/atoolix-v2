    ...
    <main className="relative isolate min-h-screen overflow-hidden bg-slate-950 text-slate-50">
      ...
      <header className="mx-auto flex w-full max-w-5xl items-center justify-between gap-3 px-4 pt-6 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2">
          <div className="flex h-6 w-6 items-center justify-center rounded-md bg-[#F1DBA0] text-xs font-bold text-slate-950">
            <Image src="/android-chrome-192x192.png" alt="Atoolix | find the best tools" title='Atoolix | find the perfect tools' className="transparent" width={24} height={24} />
          </div>
      ...
      >
        ...
        <div className="relative mb-6 flex flex-col items-center">
          <div className="relative flex items-center justify-center rounded-3xl bg-slate-900/70 px-10 py-6 shadow-2xl shadow-black/60 ring-1 ring-slate-800/70 backdrop-blur-xl">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link href="/tools" aria-label="Browse all Atoolix tools">
            <span className="inline-flex items-center gap-2 rounded-full border border-slate-700 bg-slate-900 px-5 py-2 text-sm font-medium text-slate-100 shadow-md shadow-black/40 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#F1DBA0]/70 hover:bg-slate-900">
              🧰 Browse tools
            </span>
          </Link>
        </div>
