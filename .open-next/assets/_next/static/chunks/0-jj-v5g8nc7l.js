...
`)},type:g,offsetToIndices:r=>(_.offsetToIndices=!0,p<2?r:`o2i_${t}(${r})`),indicesToOffset:r=>(_.indicesToOffset=!0,p<2?r:`i2o_${t}(${r})`),broadcastedIndicesToOffset:(r,i)=>{_.broadcastedIndicesToOffset=!0;let a=`${i.name}broadcastedIndicesTo${t}Offset`;if(a in C)return`${a}(${r})`;let n=[];for(let t=p-1;t>=0;t--){let r=i.indicesGet("outputIndices",t+i.rank-p);n.push(`${I(v,t)} * (${r} % ${I(b,t)})`)}return C[a]=`fn ${a}(outputIndices: ${i.type.indices}) -> u32 {
           ...
           }`,`${a}(${r})`},indices:T,indicesGet:I,indicesSet:(t,r,i)=>p<2?`${t}=${i};`:`${tm(t,r,p)}=${i};`,set:function(){for(var r=arguments.length,i=Array(r),a=0;a<r;a++)i[a]=arguments[a];if(i.length!==p+1)throw Error(`indices length must be ${p}`);let n=i[p];if("string"!=typeof n)throw Error("value must be string");let s=i.slice(0,p).map(y).join(",");return 0===p?E("0u",n):1===p?E(s[0],n):(_.set=!0,_.setByIndices=!0,_.indicesToOffset=!0,`set_${t}(${s}, ${n})`)},setByOffset:E,setByIndices:(r,i)=>p<2?E(r,i):(_.setByIndices=!0,_.indicesToOffset=!0,`set_${t}ByIndices(${r}, ${i});`),get:function(){for(var r=arguments.length,i=Array(r),a=0;a<r;a++)i[a]=arguments[a];if(i.length!==p)throw Error(`indices length must be ${p}`);let n=i.map(y).join(",");return 0===p?z("0u"):1===p?z(n[0]):(_.get=!0,_.getByIndices=!0,_.indicesToOffset=!0,`get_${t}(${n})`)},getByOffset:z,getByIndices:r=>p<2?z(r):(_.getByIndices=!0,_.indicesToOffset=!0,`get_${t}ByIndices(${r})`),usage:a,name:t,strides:v,shape:b,rank:p}},ty=function(t,r,i){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:1;return tg(t,r,i,"input",a)},t_=function(t,r,i){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:1;return tg(t,r,i,"output",a)},t$=(t,r,i)=>tg(t,r,i,"atomicOutput",1),tb=function(t,r,i){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:1;return tg(t,r,i,"internal",a)},tv=class{constructor(t,r){this.normalizedDispatchGroup=t,this.limits=r,this.internalVariables=[],this.variables=[],this.uniforms=[],this.variableIndex=0}guardAgainstOutOfBoundsWorkgroupSizes(t){return`if (global_idx >= ${"number"==typeof t?`${t}u`:t}) { return; }`}mainStart(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:ts,r="number"==typeof t?t:t[0],i="number"==typeof t?1:t[1],a="number"==typeof t?1:t[2];if(r>this.limits.maxComputeWorkgroupSizeX||i>this.limits.maxComputeWorkgroupSizeY||a>this.limits.maxComputeWorkgroupSizeZ)throw Error(`workgroup size [${r}, ${i}, ${a}] exceeds the maximum workgroup size [${this.limits.maxComputeWorkgroupSizeX}, ${this.limits.maxComputeWorkgroupSizeY}, ${this.limits.maxComputeWorkgroupSizeZ}].`);if(r*i*a>this.limits.maxComputeInvocationsPerWorkgroup)throw Error(`workgroup size [${r}, ${i}, ${a}] exceeds the maximum workgroup invocations ${this.limits.maxComputeInvocationsPerWorkgroup}.`);let n=1===this.normalizedDispatchGroup[1]&&1===this.normalizedDispatchGroup[2],s=n?`@builtin(global_invocation_id) global_id : vec3<u32>,
  ...
  ${t.mainStart()}
    ...
    ${i.setByOffset("global_idx",r.getByIndices("aIndices"))}
       ...
       `,{name:n,shaderCache:{hint:`${s};${y}`,inputDependencies:["type"]},getShaderSource:t=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:d,dataType:l}],dispatchGroup:{x:h},programUniforms:[{type:12,data:f}]})}),{inputs:[x]})},tO=(t,r)=>{tA(t,"ReduceMeanShared",r,"mean")},tR=(t,r)=>{tA(t,"ReduceL1Shared",r,"l1")},tB=(t,r)=>{tA(t,"ReduceL2Shared",r,"l2")},tN=(t,r)=>{tA(t,"ReduceLogSumExpShared",r,"logSumExp")},tM=(t,r)=>{tA(t,"ReduceMaxShared",r,"max")},tD=(t,r)=>{tA(t,"ReduceMinShared",r,"min")},tP=(t,r)=>{tA(t,"ReduceProdShared",r,"prod")},tU=(t,r)=>{tA(t,"ReduceSumShared",r,"sum")},tW=(t,r)=>{tA(t,"ReduceSumSquareShared",r,"sumSquare")},tq=(t,r)=>{tA(t,"ReduceLogSumShared",r,"logSum")}}),nT=U(()=>{nm(),nw(),nv(),nx(),nk(),tL=t=>{if(!t||0===t.length||t.length>2)throw Error("Reduce op requires 1 or 2 inputs.");if(2===t.length&&1!==t[1].dims.length)throw Error("Invalid axes input dims.")},tV=t=>["","",`var value = ${t.getByIndices("input_indices")};`,""],tG=function(t,r,i,a,n,s){let o=arguments.length>6&&void 0!==arguments[6]&&arguments[6],u=arguments.length>7&&void 0!==arguments[7]&&arguments[7],l=[],d=i[0].dims,p=d.length,c=tt.normalizeAxes(n,p),h=!u&&0===c.length;d.forEach((t,r)=>{h||c.indexOf(r)>=0?o&&l.push(1):l.push(t)});let f=l.length,m=tt.size(l);return{name:t,shaderCache:r,getShaderSource:t=>{let r=[],n=ty("_A",i[0].dataType,p),u=t_("output",s,f),l=a(n,u,c),m=l[2];for(let t=0,i=0;t<p;t++)h||c.indexOf(t)>=0?(o&&i++,m=`for(var j${t}: u32 = 0; j${t} < ${d[t]}; j${t}++) {
...
var best_index : i32 = 0;`,`if (${t.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
         value = ${t.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]},[r.axis],7,r.keepDims),{inputs:[0]})},t5=t=>e7(t)}),nC=U(()=>{nm(),nw(),n$(),nx(),t7=(t,r,i)=>r&&t?`
  ...
  }`}}},re=function(t,r,i,a,n,s,o,u,l,d){var p,c,h,f,m,g,y,_,$,b,v,w,x,S,k,T,I;let C,E,z,A,O,R,B,N,M,D,P,U,W,q,L,V,G,H,F,j,K,Q=arguments.length>10&&void 0!==arguments[10]?arguments[10]:void 0,Z=arguments.length>11&&void 0!==arguments[11]?arguments[11]:void 0,X=Math.min(t.outputCount,1+ +!!o+ +!!u),Y=X>1?d.pastSequenceLength:0,J=Y+d.kvSequenceLength,ee=l&&tt.size(l.dims)>0?l:void 0,et=[r,i];X>1&&o&&tt.size(o.dims)>0&&et.push(o),ee&&et.push(ee),Q&&et.push(Q),Z&&et.push(Z);let er=t.compute((p=X,c=r,h=i,f=o,m=ee,g=d,y=Y,_=Q,$=Z,C=y+g.kvSequenceLength,E=[g.batchSize,g.numHeads,g.sequenceLength,C],z=p>1&&f,A=g.kvNumHeads?g.kvNumHeads:g.numHeads,O=z?[g.batchSize,A,C,g.headSize]:void 0,R=g.nReps?g.nReps:1,B=0===g.scale?1/Math.sqrt(g.headSize):g.scale,N=tp(g.headSize),M=g.headSize/N,D={x:Math.ceil(C/12),y:Math.ceil(g.sequenceLength/12),z:g.batchSize*g.numHeads},P=[{type:12,data:g.sequenceLength},{type:12,data:M},{type:12,data:C},{type:12,data:g.numHeads},{type:12,data:g.headSize},{type:1,data:B},{type:12,data:y},{type:12,data:g.kvSequenceLength},{type:12,data:R}],U=z&&f&&tt.size(f.dims)>0,W=["type","type"],U&&W.push("type"),m&&W.push("type"),_&&W.push("type"),$&&W.push("type"),q=[{dims:E,dataType:c.dataType,gpuDataType:0}],z&&q.push({dims:O,dataType:c.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${N};${void 0!==m};${void 0!==f};${p}`,inputDependencies:W},getRunData:()=>({outputs:q,dispatchGroup:D,programUniforms:P}),getShaderSource:t=>{let r=ty("q",c.dataType,c.dims,N),i=[r,ty("key",h.dataType,h.dims,N)];if(U){let t=ty("past_key",f.dataType,f.dims,N);i.push(t)}m&&i.push(ty("attention_bias",m.dataType,m.dims));let a=_?ty("seq_lens",_.dataType,_.dims):void 0;a&&i.push(a);let n=$?ty("total_sequence_length_input",$.dataType,$.dims):void 0;n&&i.push(n);let s=t_("output",c.dataType,E),o=[s];z&&o.push(t_("present_key",c.dataType,O,N));let u=tl(1,N);return`
  const TILE_SIZE = 12u;
  ...
  ${t.mainStart([12,12,1])}
    ...
    ${U&&z?"let pastKeyOffset = absKvHeadIdx * uniforms.past_sequence_length * uniforms.K;":""};
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(()=>{switch(N){case 1:return"value";case 2:return"value.x + value.y";case 4:return"value.x + value.y + value.z + value.w";default:throw Error(`Unsupported components: ${N}`)}})()};
        output[outputIdx] = ${s.type.value} (sum * uniforms.alpha) + ${m?"attention_bias[outputIdx]":"0.0"};
    }
  }`}}),{inputs:et,outputs:X>1?[-1,1]:[-1]})[0];t.compute((b=er,v=d.batchSize,w=d.numHeads,x=Y,S=d.sequenceLength,k=J,T=Q,I=Z,L=tp(T?1:k),V=64,(G=k/L)<64&&(V=32),H=[{type:12,data:v},{type:12,data:w},{type:12,data:x},{type:12,data:S},{type:12,data:G},{type:12,data:Math.ceil(k/L/V)}],F=tu(b.dataType,L),j=tl(1,L),K=["type"],T&&K.push("type"),I&&K.push("type"),{name:"AttentionProbsSoftmax",shaderCache:{hint:`${V};${F};${L}`,inputDependencies:K},getShaderSource:t=>{let r=t_("x",b.dataType,b.dims,L),i=[r],a=T?ty("seq_lens",T.dataType,T.dims):void 0;a&&i.push(a);let n=I?ty("total_sequence_length_input",I.dataType,I.dims):void 0;n&&i.push(n);let s=tl(b.dataType);return`
  ...
  ${t.mainStart([V,1,1])}
    ...
    let seq_causal_length = ${T?"u32(past_sequence_length + workgroup_id.y + 1)":"total_sequence_length"};
  ...
  }`,r.cacheKey))},rb=function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"f32";return`
...
}`},rv=t=>{let r=tl(t.inputs[0].dataType);t.compute(ra(t.inputs[0],"Erf",t=>`erf_vf32(${t})`,rb(r)))},rw=t=>{t.compute(ra(t.inputs[0],"Exp","exp"))},rx=t=>{t.compute(ra(t.inputs[0],"Floor","floor"))},rS=t=>{let r=tl(t.inputs[0].dataType);t.compute(ra(t.inputs[0],"Gelu",t=>`0.5 * ${t} * (1.0 + erf_vf32(${t} * 0.7071067811865475))`,rb(r)))},rk=(t,r)=>{let i=tl(t.inputs[0].dataType);t.compute(ra(t.inputs[0],"LeakyRelu",t=>`select(leaky_relu_alpha_ * ${t}, ${t}, ${t} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${r.alpha});`,r.cacheKey))},rT=t=>{t.compute(ra(t.inputs[0],"Not",t=>`!${t}`))},rI=t=>{t.compute(ra(t.inputs[0],"Neg",t=>`-${t}`))},rC=t=>{t.compute(ra(t.inputs[0],"Reciprocal",t=>`1.0/${t}`))},rE=t=>{let r=tl(t.inputs[0].dataType);t.compute(ra(t.inputs[0],"Relu",t=>`select(vec4<${r}>(0.0), ${t}, ${t} > vec4<${r}>(0.0))`))},rz=t=>{t.compute(ra(t.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},rA=t=>e7(t),rO=(t,r)=>{let i=tl(t.inputs[0].dataType);t.compute(ra(t.inputs[0],"HardSigmoid",t=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${r.alpha} * ${t} + vec4<${i}>(${r.beta})))`,void 0,r.cacheKey))},rR=t=>{t.compute(ra(t.inputs[0],"Sin","sin"))},rB=t=>{t.compute(ra(t.inputs[0],"Sinh","sinh"))},rN=t=>{t.compute(ra(t.inputs[0],"Sqrt","sqrt"))},rM=t=>{t.compute(ra(t.inputs[0],"Tan","tan"))},rD=t=>`sign(${t}) * (1 - exp(-2 * abs(${t}))) / (1 + exp(-2 * abs(${t})))`,rP=t=>{t.compute(ra(t.inputs[0],"Tanh",rD))},rU=function(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"f32";return`
...
`},rW=t=>`(fast_gelu_a + fast_gelu_a * tanh_v(${t} * (fast_gelu_c * ${t} * ${t} + fast_gelu_b))) * ${t}`,rq=t=>{let r=tl(t.inputs[0].dataType);t.compute(ra(t.inputs[0],"FastGelu",rW,rU(r),void 0,t.inputs[0].dataType))},rL=(t,r)=>{let i=tl(t.inputs[0].dataType);return t.compute(ra(t.inputs[0],"ThresholdedRelu",t=>`select(vec4<${i}>(0.0), ${t}, ${t} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${r.alpha});`,r.cacheKey)),0},rV=t=>{t.compute(ra(t.inputs[0],"Log","log"))},rG=t=>`quick_gelu_impl(${t})`,rH=(t,r)=>{let i,a,n=tl(t.inputs[0].dataType);t.compute(ra(t.inputs[0],"QuickGelu",rG,(i=n,a=r.alpha,`
...
`),r.cacheKey,t.inputs[0].dataType))}}),nO=U(()=>{nw(),nx(),nA(),rF=t=>{var r;let i,a,n,s,o,u;(t=>{if(3!==t[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(t[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==t[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(t[0].dims[2]!==t[1].dims[0])throw Error("last dimension of input and bias are not the same")})(t.inputs),t.compute(((i=(r=t.inputs)[0].dims.slice())[2]=i[2]/2,a=ty("input",r[0].dataType,r[0].dims,4),n=ty("bias",r[0].dataType,[r[0].dims[2]],4),s=t_("output",r[0].dataType,i,4),o=tt.size(i)/4,u=tu(r[0].dataType),{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${s.setByOffset("global_idx","valueLeft * geluRight")}
          ...
          `}else _=m.setByOffset("global_idx",f(g.getByOffset("global_idx"),y.getByOffset("global_idx")));else{if(!s)throw Error("no necessary to use scalar implementation for element-wise binary op implementation.");let t=function(t,r){let i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",a=`aData[indexA${r}][componentA${r}]`,n=`bData[indexB${r}][componentB${r}]`;return`
        ...
        ${_}
      }`})(t,u,l,p,h,d,f,n,i.dataType,a.dataType,o,s),getRunData:()=>({outputs:[{dims:p,dataType:o}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil(tt.size(p)/4)},...td(u,l,p)]})}},rK=(t,r,i,a,n,s)=>{t.compute(rj(r,n??"",t.inputs[0],t.inputs[1],i,a,s))},rQ=t=>{rK(t,"Add",(t,r)=>`${t}+${r}`)},rZ=t=>{rK(t,"Div",(t,r)=>`${t}/${r}`)},rX=t=>{rK(t,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},rY=t=>{rK(t,"Mul",(t,r)=>`${t}*${r}`)},rJ=t=>{let r=ty("input",t.inputs[0].dataType,t.inputs[0].dims).type.value;rK(t,"Pow",{scalar:(t,r)=>`pow_custom(${t},${r})`,vector:(t,r)=>`pow_vector_custom(${t},${r})`},`
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},r0=t=>{rK(t,"Sub",(t,r)=>`${t}-${r}`)},r1=t=>{rK(t,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},r2=t=>{rK(t,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},r3=t=>{rK(t,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},r4=t=>{rK(t,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}}),nB=U(()=>{nm(),nw(),nv(),nx(),r6=(t,r)=>{let i=t.inputs,a=i[0].dims,n=tt.normalizeAxis(r.axis,a.length);var s=i,o=n;if(!s||s.length<1)throw Error("too few inputs");let u=s[0],l=u.dataType,d=u.dims.length;s.forEach((t,r)=>{if(0!==r){if(t.dataType!==l)throw Error("input tensors should be one type");if(t.dims.length!==d)throw Error("input tensors should have the same shape");t.dims.forEach((t,r)=>{if(r!==o&&t!==u.dims[r])throw Error("non concat dimensions must match")})}});let p=a.slice();p[n]=i.reduce((t,r)=>t+(r.dims.length>n?r.dims[n]:0),0);let c=i.filter(t=>tt.size(t.dims)>0);t.compute(((t,r,i,a)=>{let n=tt.size(i),s=Array(t.length),o=Array(t.length),u=0,l=[],d=[],p=[{type:12,data:n}];for(let i=0;i<t.length;++i)u+=t[i].dims[r],s[i]=u,d.push(t[i].dims.length),o[i]=ty(`input${i}`,a,d[i]),l.push("rank"),p.push({type:12,data:s[i]});for(let r=0;r<t.length;++r)p.push(...td(t[r].dims));p.push(...td(i));let c=t_("output",a,i.length),h=c.indicesGet("indices",r),f=Array.from(Array(s.length).keys()).map(t=>`uniforms.sizeInConcatAxis${t}`).join(",");return{name:"Concat",shaderCache:{hint:`${r}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p}),getShaderSource:r=>{let i,a;return`
...
`)})(o,c)}
  }`}}})(c,n,p,i[0].dataType),{inputs:c})},r8=t=>e7({axis:t.axis})}),nN=U(()=>{nm(),nw(),r5=function(t,r){let i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"f32";switch(t.activation){case"Relu":return`value = max(value, ${r}(0.0));`;case"Sigmoid":return`value = (${r}(1.0) / (${r}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${r}(${i}(uniforms.clip_min)), ${r}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${r}(0.0), min(${r}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${r}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw Error(`Unsupported activation ${t.activation}`)}},r7=(t,r)=>{"Clip"===t.activation?r.push({type:1,data:t.clipMax},{type:1,data:t.clipMin}):"HardSigmoid"===t.activation?r.push({type:1,data:t.alpha},{type:1,data:t.beta}):"LeakyRelu"===t.activation&&r.push({type:1,data:t.alpha})},r9=(t,r)=>{"Clip"===t.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===t.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===t.activation&&r.push({name:"alpha",type:"f32"})},ie=t=>{let r=t?.activation||"";if("HardSigmoid"===r){let[i,a]=t?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=t?.activation_params||[ta,tn];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=t?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),nM=U(()=>{it=(t,r)=>{switch(t){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${t}-component is not supported.`)}},ir=t=>`
...
`}),nP=U(()=>{nm(),nw(),nx(),nN(),ia=(t,r,i,a,n)=>{let s=a-i;return`
...
`},is=function(t,r,i,a){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4],s=arguments.length>5?arguments[5]:void 0,o=t[0].dims,u=t[1].dims,l=o[o.length-2],d=u[u.length-1],p=o[o.length-1],c=tp(d),h=tp(p),f=tp(l),m=tt.size(i)/c/f,g=t.length>2,y=a?a.slice(0,-2):i.slice(0,-2),_=[tt.size(y),l,d],$=[{type:12,data:m},{type:12,data:l},{type:12,data:d},{type:12,data:p}];return r7(r,$),$.push(...td(y,o,u)),g&&$.push(...td(t[2].dims)),$.push(...td(_)),{name:"MatMulNaive",shaderCache:{hint:`${r.activation};${c};${h};${f};${n}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:$}),getShaderSource:a=>{let s=tb("batch_dims",t[0].dataType,y.length),l=ty("a",t[0].dataType,o.length,h),d=ty("b",t[1].dataType,u.length,c),p=t_("output",t[0].dataType,_.length,c),m=tu(p.type.tensor),$=r5(r,p.type.value,m),b=[l,d],v="";if(g){let r=n?c:1;b.push(ty("bias",t[2].dataType,t[2].dims.length,r)),v=`${n?`value += bias[col / ${r}];`:`value += ${p.type.value}(bias[row + i]);`}`}let w=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];return r9(r,w),`
...
`}return t})()}
  ...
  `}}}}),nU=U(()=>{nm(),nw(),nx(),nN(),nP(),nM(),io=function(t,r){let i,a,n,s,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"f32",u=arguments.length>3?arguments[3]:void 0,l=arguments.length>4&&void 0!==arguments[4]&&arguments[4],d=arguments.length>5&&void 0!==arguments[5]?arguments[5]:32,p=arguments.length>6&&void 0!==arguments[6]&&arguments[6],c=arguments.length>7&&void 0!==arguments[7]?arguments[7]:32,h=r[1]*t[1],f=r[0]*t[0],m=l?h:d,g=l?d:h,y=m/r[0],_=d/r[1];if(!((l&&4===y&&4===t[1]||!l&&(3===y||4===y))&&m%r[0]==0&&d%r[1]==0&&4===t[0]))throw Error(`If transposeA ${l} is true, innerElementSize ${y} and workPerThread[1] ${t[1]} must be 4.
      Otherwise, innerElementSize ${y} must be 3 or 4.
  tileAWidth ${m} must be divisible by workgroupSize[0]${r[0]}. tileInner ${d} must be divisible by workgroupSize[1] ${r[1]}. colPerThread ${t[0]} must be 4.`);return`
var<workgroup> mm_Asub: array<array<vec${y}<${o}>, ${m/y}>, ${g}>;
var<workgroup> mm_Bsub: array<array<vec4<${o}>, ${f/t[0]}>, ${d}>;
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  let num_tiles = ${p?`${Math.ceil(c/d)}`:"(uniforms.dim_inner - 1) / tileInner + 1"};
  var kStart = ${p?`i32(globalId.z) * ${c}`:"0"};
  ...
  for (var t = 0; t < num_tiles; t = t + 1) {
      ...
      for (var k = 0; k < tileInner / innerElementSize; k = k + 1) {
        ...
        ${3===s?"":"let ACached3 = mm_Asub[k * innerElementSize + 3][localRow];"}
        for (var i = 0; i < rowPerThread; i = i + 1) {
          acc[i] = BCached0 * ACached0[i] + acc[i];
          acc[i] = BCached1 * ACached1[i] + acc[i];
          acc[i] = BCached2 * ACached2[i] + acc[i];
          ${3===s?"":"acc[i] = BCached3 * ACached3[i] + acc[i];"}
        }`:`
        for (var i = 0; i < rowPerThread; i = i + 1) {
          ...
          ${3===s?"":"acc[i] = BCached3 * ACached.w + acc[i];"}
        }`}
      }
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,il=function(t,r){let i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"f32",a=arguments.length>3?arguments[3]:void 0,n=arguments.length>4&&void 0!==arguments[4]&&arguments[4],s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:32,o=arguments.length>6&&void 0!==arguments[6]&&arguments[6],u=arguments.length>7&&void 0!==arguments[7]?arguments[7]:32,l=arguments.length>8&&void 0!==arguments[8]&&arguments[8],d=t[1]*r[1],p=t[0]*r[0],c=n?d:s,h=n?s:d;if(h%r[1]!=0||c%r[0]!=0||s%r[1]!=0)throw Error(`tileAHight ${h} must be divisible by workgroupSize[1]${r[1]}, tileAWidth ${c} must be divisible by workgroupSize[0]${r[0]}, tileInner ${s} must be divisible by workgroupSize[1]${r[1]}`);let f=h/r[1],m=c/r[0],g=s/r[1],y=l?`
    let localRow = i32(localId.y);
...
`},id=function(t,r,i,a){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4],[s,o,u,l]=a,d=tu(a[0].type.tensor);return`
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${it(t,d)} {
      var value = ${it(t,d)}(0.0);
      let col = colIn * ${t};
      if(row < uniforms.dim_a_outer && col < uniforms.dim_inner)
      {
        var aIndices: ${o.type.indices};
        ${ia("aIndices",o,o.rank-2,s.rank,"batchIndices")}
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${it(t,d)} {
      var value = ${it(t,d)}(0.0);
      let col = colIn * ${t};
      if(row < uniforms.dim_inner && col < uniforms.dim_b_outer)
      {
        var bIndices: ${u.type.indices};
        ${ia("bIndices",u,u.rank-2,s.rank,"batchIndices")}
    ...
    fn mm_write(batch: i32, row: i32, colIn: i32, valueIn: ${it(t,d)}) {
      let col = colIn * ${t};
      if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
        var value = valueIn;
        let coords = vec3<i32>(batch, row, colIn);
        ${r?`value = value + ${n?"bias[colIn]":`${it(t,d)}(bias[row])`};`:""}
        ${i}
        ${l.setByIndices("vec3<u32>(coords)","value")}
      }
    }
    `},ip=function(t,r,i,a){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4],s=arguments.length>5?arguments[5]:void 0,o=t[0].dims,u=t[1].dims,l=o.slice(0,-2),d=u.slice(0,-2),p=a?a.slice(0,-2):i.slice(0,-2),c=tt.size(p),h=o[o.length-2],f=o[o.length-1],m=u[u.length-1],g=f%4==0&&m%4==0,y=h<=8?[4,1,1]:[4,4,1],_=[8,8,1],$=[Math.ceil(m/_[0]/y[0]),Math.ceil(h/_[1]/y[1]),Math.ceil(c/_[2]/y[2])],b=g?4:1,v=[...l,h,f/b],w=v.length,x=[...d,f,m/b],S=x.length,k=[c,h,m/b],T=[{type:6,data:h},{type:6,data:m},{type:6,data:f}];r7(r,T),T.push(...td(p,v,x));let I=["rank","rank"],C=t.length>2;return C&&(T.push(...td(t[2].dims)),I.push("rank")),T.push(...td(k)),{name:"MatMul",shaderCache:{hint:`${y};${r.activation};${g};${n}`,inputDependencies:I},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:t[0].dataType}],dispatchGroup:{x:$[0],y:$[1],z:$[2]},programUniforms:T}),getShaderSource:i=>{let a=p.length,s=tb("batchDims",t[0].dataType,a,1),o=tu(t[0].dataType),u=ty("a",t[0].dataType,w,b),l=ty("b",t[1].dataType,S,b),d=t_("result",t[0].dataType,k.length,b),c=[u,l];if(C){let r=n?b:1;c.push(ty("bias",t[2].dataType,t[2].dims.length,r))}let h=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];r9(r,h);let f=tu(d.type.tensor),m=id(b,C,r5(r,d.type.value,f),[s,u,l,d],n);return`
  ${i.registerUniforms(h).registerInternalVariables(s).declareVariables(...c,d)}
  ${m}
  ${g?io(y,_,o,s):il(y,_,o,s)}
                   `}}}}),nW=U(()=>{nm(),ny(),nx(),nN(),nM(),nD(),nU(),ic=function(t,r,i,a){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4],s=arguments.length>5?arguments[5]:void 0,o=arguments.length>6&&void 0!==arguments[6]?arguments[6]:4,u=arguments.length>7&&void 0!==arguments[7]?arguments[7]:4,l=arguments.length>8&&void 0!==arguments[8]?arguments[8]:4,d=arguments.length>9&&void 0!==arguments[9]?arguments[9]:"f32",p=t=>{switch(t){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw Error(`innerElementSize ${t} is not supported.`)}},c=t?`
    ...
    return ${it(u,d)}(0.0);`,$=it(l,d),b=t?it(o,d):it(u,d),v=t?it(u,d):it(o,d),w=r5(s,$,d);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${$}) {
    ...
    }`},ih=(t,r,i,a,n,s,o,u,l)=>{let d="NHWC"===r.format,p=d?t[0].dims[3]:t[0].dims[1],c=i[0],h=d?i[2]:i[3],f=d?i[1]:i[2],m=d?i[3]:i[1],g=d&&(p%4==0||p%3==0)&&m%4==0,y=d?m:h*f,_=d?h*f:m,$=[8,8,1],b=a<=8?[4,1,1]:[4,4,1],v=[Math.ceil(y/$[0]/b[0]),Math.ceil(_/$[1]/b[1]),Math.ceil(c/$[2]/b[2])];eX("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${v}`);let w=g?d&&p%4!=0?3:4:1,x=$[1]*b[1],S=$[0]*b[0],k=Math.max($[0]*w,$[1]),T=a%x==0,I=n%S==0,C=s%k==0,E=g?[w,4,4]:[1,1,1],z=[{type:6,data:a},{type:6,data:n},{type:6,data:s},{type:6,data:[r.pads[0],r.pads[1]]},{type:6,data:r.strides},{type:6,data:r.dilations}];r7(r,z),z.push(...td(t[0].dims,t[1].dims));let A=["rank","rank"];return o&&(z.push(...td(t[2].dims)),A.push("rank")),z.push(...td(i)),{name:"Conv2DMatMul",shaderCache:{hint:`${r.cacheKey};${w};${g};${T};${I};${C};${x};${S};${k}`,inputDependencies:A},getRunData:()=>({outputs:[{dims:l?l(i):i,dataType:t[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:z}),getShaderSource:a=>{let n=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];r9(r,n);let s=g?4:1,l=tu(t[0].dataType),p=`
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${g?`vec4<${l}>`:l}) {
        ...
        ${p}
        ${ic(d,T,I,C,o,r,E[0],E[1],E[2],l)}
        ${g?io(b,$,l,void 0,!d,k):il(b,$,l,void 0,!d,k,!1,void 0,u)}`}}}}),nq=U(()=>{nm(),ny(),nw(),nx(),nN(),nM(),im=t=>"number"==typeof t?[t,t,t]:t,ig=(t,r)=>r<=1?t:t+(t-1)*(r-1),iy=function(t,r,i){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:1,n=ig(r,a);return Math.floor((t[0]*(i-1)-i+n)/2)},i_=(t,r,i,a,n)=>{null==n&&(n=iy(t,r[0],a[0]));let s=[0,0,0,i];for(let i=0;i<3;i++)t[i]+2*n>=r[i]&&(s[i]=Math.trunc((t[i]-r[i]+2*n)/a[i]+1));return s},i$=function(t,r,i,a,n){let s,o,u,l,d,p=arguments.length>5&&void 0!==arguments[5]&&arguments[5],c=arguments.length>6&&void 0!==arguments[6]?arguments[6]:"channelsLast";if("channelsLast"===c)[s,o,u,l,d]=t;else if("channelsFirst"===c)[s,d,o,u,l]=t;else throw Error(`Unknown dataFormat ${c}`);let[h,,f,m,g]=r,[y,_,$]=im(i),[b,v,w]=im(a),x=ig(f,b),S=ig(m,v),k=ig(g,w),{padInfo:T,outDepth:I,outHeight:C,outWidth:E}=((t,r,i,a,n,s,o,u,l,d)=>{let p,c,h,f;if("VALID"===t&&(t=0),"number"==typeof t){p={top:t,bottom:t,left:t,right:t,front:t,back:t};let m=i_([r,i,a,1],[u,l,d],1,[n,s,o],t);c=m[0],h=m[1],f=m[2]}else if(Array.isArray(t)){if(!t.every((t,r,i)=>t===i[0]))throw Error(`Unsupported padding parameter: ${t}`);p={top:t[0],bottom:t[1],left:t[2],right:t[3],front:t[4],back:t[5]};let m=i_([r,i,a,1],[u,l,d],1,[n,s,o],t[0]);c=m[0],h=m[1],f=m[2]}else if("SAME_UPPER"===t){c=Math.ceil(r/n),h=Math.ceil(i/s),f=Math.ceil(a/o);let t=(c-1)*n+u-r,m=(h-1)*s+l-i,g=(f-1)*o+d-a,y=Math.floor(t/2),_=Math.floor(m/2),$=Math.floor(g/2);p={top:_,bottom:m-_,left:$,right:g-$,front:y,back:t-y}}else throw Error(`Unknown padding parameter: ${t}`);return{padInfo:p,outDepth:c,outHeight:h,outWidth:f}})(n,o,u,l,y,_,$,x,S,k),z=p?h*d:h,A=[0,0,0,0,0];return"channelsFirst"===c?A=[s,z,I,C,E]:"channelsLast"===c&&(A=[s,I,C,E,z]),{batchSize:s,dataFormat:c,inDepth:o,inHeight:u,inWidth:l,inChannels:d,outDepth:I,outHeight:C,outWidth:E,outChannels:z,padInfo:T,strideDepth:y,strideHeight:_,strideWidth:$,filterDepth:f,filterHeight:m,filterWidth:g,effectiveFilterDepth:x,effectiveFilterHeight:S,effectiveFilterWidth:k,dilationDepth:b,dilationHeight:v,dilationWidth:w,inShape:t,outShape:A,filterShape:r}},ib=(t,r,i,a,n,s)=>{let o="channelsLast"===s,u=[Math.ceil((t=>{let r=1;for(let i=0;i<t.length;i++)r*=t[i];return r})((o?t[0].dims[3]:t[0].dims[1],{x:i.map((t,r)=>r)}).x.map(t=>i[t]))/64),1,1];eX("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${u}`);let l=[{type:12,data:tt.size(i)},{type:12,data:a},{type:12,data:n},{type:12,data:r.strides},{type:12,data:r.dilations}];r7(r,l),l.push(...td(t[0].dims,t[1].dims));let d=["rank","rank"],p=3===t.length;return p&&(l.push(...td(t[2].dims)),d.push("rank")),l.push(...td(i)),{name:"Conv3DNaive",shaderCache:{hint:`${r.cacheKey};${o};1;${p}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:u[0],y:u[1],z:u[2]},programUniforms:l}),getShaderSource:s=>{let u=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:a.length},{name:"pads",type:"u32",length:n.length},{name:"strides",type:"u32",length:r.strides.length},{name:"dilations",type:"u32",length:r.dilations.length}];r9(r,u);let l=tu(t[0].dataType),d=ty("x",t[0].dataType,t[0].dims.length,1),c=ty("W",t[1].dataType,t[1].dims.length,1),h=[d,c],f=t_("result",t[0].dataType,i.length,1),m="";if(p){let r=ty("bias",t[2].dataType,t[2].dims.length,1);h.push(r),m+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${l} {
          return bias[${o?tm("coords",4,5):tm("coords",1,5)}];
        }`}let g=it(1,l),y=r5(r,g,l);return`
            ${m}
          ...
          }`}}}}),nL=U(()=>{nm(),nw(),nx(),nN(),iv=(t,r,i,a)=>{let n=t.length>2,s=n?"value += b[output_channel];":"",o=t[0].dims,u=t[1].dims,l="NHWC"===r.format,d=l?i[3]:i[1],p=d/r.group,c=l&&p>=4?tp(d):1,h=tt.size(i)/c,f=[{type:12,data:h},{type:12,data:r.dilations},{type:12,data:[r.strides[0],r.strides[1]]},{type:12,data:[r.pads[0],r.pads[1]]},{type:12,data:p}];return r7(r,f),f.push(...td(o,[u[0],u[1],u[2],u[3]/c])),f.push(...td([i[0],i[1],i[2],i[3]/c])),{name:"GroupedConv",shaderCache:{hint:`${r.cacheKey}_${c}`,inputDependencies:n?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:f}),getShaderSource:a=>{let d=t_("output",t[0].dataType,i.length,c),p=tu(d.type.tensor),h=r5(r,d.type.value,p),f=ty("x",t[0].dataType,o.length),m=ty("w",t[1].dataType,u.length,c),g=[f,m];n&&g.push(ty("b",t[2].dataType,t[2].dims,c));let y=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:r.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];r9(r,y);let _=l?`
  ...
  ${a.mainStart()}
    ...
    ${h}
    ${d.setByOffset("global_idx","value")}
  }`}}},iw=(t,r,i,a)=>{let n=t.length>2,s=tp(i[3]),o=tp(i[2]),u=tt.size(i)/s/o,l=[t[0].dims[0],t[0].dims[1],t[0].dims[2],t[0].dims[3]/s],d=[t[1].dims[0],t[1].dims[1],t[1].dims[2],t[1].dims[3]/s],p=[i[0],i[1],i[2],i[3]/s],c=[{type:12,data:u},{type:6,data:[r.strides[0],r.strides[1]]},{type:6,data:[r.pads[0],r.pads[1]]}];r7(r,c),c.push(...td(l,d,p));let h=(o-1)*r.strides[1]+d[1];return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${r.cacheKey};${s};${o};${h};${d[0]};${d[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c}),getShaderSource:i=>{let a=t_("output",t[0].dataType,p.length,s),u=tu(a.type.tensor),c=r5(r,a.type.value,u),f=ty("x",t[0].dataType,l.length,s),m=ty("w",t[1].dataType,d.length,s),g=[f,m];n&&g.push(ty("b",t[2].dataType,t[2].dims,s));let y=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return r9(r,y),`
...
`)};
          ...
          }`}}))},iF=t=>{let r=t.equation.replace(/\s+/g,"");return e7({equation:r})}}),nQ=U(()=>{nm(),nw(),nx(),ij=(t,r)=>{let i=t.length-r.length,a=[];for(let r=0;r<i;++r)a.push(t[r]);for(let n=0;n<r.length;++n)a.push(1===r[n]?t[n+i]:r[n]);return a},iK=t=>{var r;let i,a,n,s,o,u,l,d,p,c;(t=>{if(!t||2!==t.length)throw Error("Expand requires 2 input.");let r=t[0].dims,i=Array.from(t[1].getBigInt64Array(),Number),a=i.length<r.length?0:i.length-r.length,n=r.length<i.length?0:r.length-i.length;for(;a<i.length&&n<r.length;++a,++n)if(i[a]!==r[n]&&1!==i[a]&&1!==r[n])throw Error("Expand requires shape to be broadcastable to input")})(t.inputs),t.compute((s=(i=n=(r=t.inputs)[0].dims,a=Array.from(r[1].getBigInt64Array(),Number),i.length>a.length?ij(i,a):ij(a,i)),u=9===(o=r[0].dataType)||1===tt.size(n),l=9===o||n.length>0&&n[n.length-1]%4==0?4:1,d=u||s.length>0&&s[s.length-1]%4==0?4:1,c=[{type:12,data:p=Math.ceil(tt.size(s)/d)},...td(n,s)],{name:"Expand",shaderCache:{hint:`${s.length};${l}${d}`,inputDependencies:["rank"]},getShaderSource:t=>{let r=ty("input",o,n.length,l),i=t_("output",o,s.length,d),a;if(9===o){let t=function(t,a){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"";return`
    ...
    ${t.mainStart()}
    ${t.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ${a}`},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c})}),{inputs:[0]})}}),nZ=U(()=>{nm(),nw(),nx(),nA(),iQ=t=>{var r;let i,a,n,s;t.inputs.length<2||0===tt.size(t.inputs[1].dims)?rq(t):t.compute((i=(r=t.inputs)[0].dataType,a=tt.size(r[0].dims),s=(n=tt.size(r[1].dims))%4==0,{name:"FastGeluWithBias",shaderCache:{hint:`${s}`,inputDependencies:["type","type"]},getShaderSource:t=>{let r=ty("x",i,[1],4),a=ty("bias",i,[1],4),n=t_("y",i,[1],4),o=t=>`
    ...
    }`},getRunData:t=>({outputs:[{dims:t[0].dims,dataType:t[0].dataType}],programUniforms:[{type:12,data:Math.ceil(a/4)},{type:12,data:n}],dispatchGroup:{x:Math.ceil(a/ts/4)}})}))}}),nX=U(()=>{nm(),nw(),nv(),nx(),iZ=t=>e7({axis:t.axis}),iX=(t,r)=>{var i,a;let n,s,o,u,l,d,p,c,h;(t=>{if(!t||2!==t.length)throw Error("Gather requires 2 inputs.")})(t.inputs),t.compute((i=t.inputs,a=r,n=i[0].dims,s=i[1].dims,o=n.length,u=tt.normalizeAxis(a.axis,o),(l=n.slice(0)).splice(u,1,...s),d=n[u],p=9===i[0].dataType?4:1,h=[{type:12,data:c=Math.ceil(tt.size(l)/p)},{type:6,data:d},{type:12,data:u},...td(i[0].dims,i[1].dims,l)],{name:"Gather",shaderCache:{hint:a.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:i[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:t=>{let r=ty("data",i[0].dataType,i[0].dims.length,p),a=ty("inputIndices",i[1].dataType,i[1].dims.length),n=t_("output",i[0].dataType,l.length,p),d=t=>{let i=s.length,n=`var indicesIndices${t}  = ${a.type.indices}(0);`;for(let r=0;r<i;r++)n+=`${i>1?`indicesIndices${t}[${r}]`:`indicesIndices${t}`} = ${l.length>1?`outputIndices${t}[uniforms.axis + ${r}]`:`outputIndices${t}`};`;n+=`
          var idx${t} = ${a.getByIndices(`indicesIndices${t}`)};
          if (idx${t} < 0) {
            idx${t} = idx${t} + uniforms.axisDimLimit;
          }
          var dataIndices${t} : ${r.type.indices};
        `;for(let r=0,a=0;r<o;r++)r===u?(n+=`${o>1?`dataIndices${t}[${r}]`:`dataIndices${t}`} = u32(idx${t});`,a+=i):(n+=`${o>1?`dataIndices${t}[${r}]`:`dataIndices${t}`} = ${l.length>1?`outputIndices${t}[${a}]`:`outputIndices${t}`};`,a++);return n},c;if(9===i[0].dataType){let t=function(t,i){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"";return`
  ...
  ${t.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
    ...
    }`}}))},i1=t=>e7({blockSize:t.blockSize,gatherAxis:t.gatherAxis,quantizeAxis:t.quantizeAxis})}),n0=U(()=>{nm(),nw(),nv(),nx(),i2=t=>e7({axis:t.axis}),i3=(t,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y;(t=>{if(!t||2!==t.length)throw Error("GatherElements requires 2 inputs.");if(t[0].dims.length<1)throw Error("GatherElements requires that the data input be rank >= 1.");if(t[0].dims.length!==t[1].dims.length)throw Error(`GatherElements requires that the data input and
      ...
      ${g.setByOffset("global_idx","value")};
  }`}))}}),n1=U(()=>{nm(),nw(),nx(),i4=t=>({transA:t.transA,transB:t.transB,alpha:t.alpha,beta:t.beta,cacheKey:`${t.transA};${t.transB};${1===t.alpha}`}),i6=(t,r)=>{(t=>{if(!t)throw Error("Input is missing");if(t.length<2||t.length>3)throw Error("Invaid input number.");if(3===t.length&&t[2].dims.length>2)throw Error("Invalid input shape of C");if(t[0].dataType!==t[1].dataType||3===t.length&&t[0].dataType!==t[2].dataType)throw Error("Input types are mismatched")})(t.inputs),t.compute(((t,r)=>{let i=t[0].dims.slice(),a=t[1].dims.slice(),[n,s,o]=ti.getShapeOfGemmResult(i,r.transA,a,r.transB,3===t.length?t[2].dims:void 0),u=[n,s],l=Math.ceil(s/16),d=Math.ceil(n/16),p=(tt.size(u),[{type:12,data:l},{type:12,data:n},{type:12,data:s},{type:12,data:o},{type:1,data:r.alpha},{type:1,data:r.beta}]),c=["type","type"];return 3===t.length&&(p.push(...td(t[2].dims)),c.push("rank")),p.push(...td(u)),{name:"GemmShared",shaderCache:{hint:`${r.cacheKey}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:u,dataType:t[0].dataType}],dispatchGroup:{x:l*d},programUniforms:p}),getShaderSource:i=>{let a=ty("a",t[0].dataType,t[0].dims),n=ty("b",t[1].dataType,t[1].dims),s=null,o=[a,n];3===t.length&&(s=ty("c",t[2].dataType,t[2].dims.length),o.push(s));let l=t_("output",t[0].dataType,u.length);o.push(l);let d="",p="";r.transA&&r.transB?(p=`
  ...
  }`}}})(t.inputs,r))}}),n2=U(()=>{nm(),nw(),nv(),nx(),[i8,i5,i7,i9]=[0,1,2,3],ae=`
...
`,at=(t,r)=>{var i,a;let n,s,o,u,l,d,p;(t=>{if(4!==t[0].dims.length)throw Error("only 4-D tensor is supported.");if(t[0].dims.length!==t[1].dims.length)throw Error("input dimensions must be equal to grid dimensions");if(t[0].dims.length-2!==t[1].dims[t[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${t[0].dims.length-2}`);if(t[0].dims[0]!==t[1].dims[0])throw Error("grid batch size must match input batch size")})(t.inputs),t.compute((i=t.inputs,a=r,n=ty("x",i[0].dataType,i[0].dims.length),s=[i[1].dims[0],i[1].dims[1],i[1].dims[2]],o=ty("grid",i[1].dataType,s.length,2),u=[i[0].dims[0],i[0].dims[1],i[1].dims[1],i[1].dims[2]],"NHWC"===a.format&&(u=[i[0].dims[0],i[1].dims[1],i[1].dims[2],i[0].dims[3]],[i8,i5,i7,i9]=[0,3,1,2]),l=t_("output",i[0].dataType,u.length),d=n.type.value,p=[{type:12,data:tt.size(u)},...td(i[0].dims,s,u)],{name:"GridSample",shaderCache:{hint:`${a.cacheKey}`,inputDependencies:["type","type"]},getRunData:t=>{let r=tt.size(u);return{outputs:[{dims:u,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:p}},getShaderSource:t=>{let r,i,s,u,p,c,h,f,m;return`
...
`}
  ...
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${p} {
     ...
     indices[${i8}] = batch;
     indices[${i5}] = channel;`+(()=>{switch(c.paddingMode){case"zeros":return`
          if (r >= 0 && r < H && c >=0 && c < W) {
            indices[${i7}] = u32(r);
            indices[${i9}] = u32(c);
          }
        `;case"border":return`
          indices[${i7}] = u32(clamp(r, 0, H - 1));
          indices[${i9}] = u32(clamp(c, 0, W - 1));
        `;case"reflection":return`
          indices[${i7}] = gs_reflect(r, border[1], border[3]);
          indices[${i9}] = gs_reflect(c, border[0], border[2]);
...
`}
  ...
  ${t.mainStart()}
    ${t.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      let H_in = i32(uniforms.x_shape[${i7}]);
      let W_in = i32(uniforms.x_shape[${i9}]);
      ...
      var grid_indices = vec3<u32>(indices[${i8}], indices[${i7}], indices[${i9}]);
      let nxy = ${o.getByIndices("grid_indices")};
      var x = gs_denormalize(f32(nxy[0]), W_in);
      var y = gs_denormalize(f32(nxy[1]), H_in);

      ${h=l,f=d,m=a,(()=>{switch(m.mode){case"nearest":return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${i8}], indices[${i5}], border);
        `;case"bilinear":return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${i8}], indices[${i5}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${i8}], indices[${i5}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${i8}], indices[${i5}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${i8}], indices[${i5}], border);
        ...
        `;case"bicubic":return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${i8}], indices[${i5}], border);
            }
          }
...
`)}
  ...
  }`}},{inputs:[r,i,a],outputs:[-1]})[0]},am=(t,r)=>{var i,a,n;let s,o,u,l,d,p,c,h,f;"NHWC"===r.format?((t,r,i)=>{let a=r[0].dims,n=a[0],s=a[a.length-1],o=tt.sizeFromDimension(a,1)/s,u=tp(s),l=tt.size(a)/u,d=[{type:12,data:o},{type:12,data:Math.floor(s/u)}],p=!1,c=[0,a.length-1];for(let t=0;t<a.length-2;t++)p=p||1!==a[t+1],c.push(t+1);let h=(p=p&&1!==a[a.length-1])?t.compute(tS(t.inputs[0],c),{inputs:[t.inputs[0]],outputs:[-1]})[0]:t.inputs[0].reshape(Array.from({length:a.length},(t,r)=>a[c[r]])),f=af(t,h,r[1],r[2],n,o,s,i.epsilon);t.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:t=>{let i=tu(r[0].dataType),n=1===u?"vec2f":`mat${u}x2f`,s=t=>{let r=0===t?"x":"y",a=1===u?"f32":`vec${u}f`;switch(u){case 1:return`${i}(${a}(scale.${r}))`;case 2:return`vec2<${i}>(${a}(scale[0].${r}, scale[1].${r}))`;case 4:return`vec4<${i}>(${a}(scale[0].${r}, scale[1].${r}, scale[2].${r}, scale[3].${r}))`;default:throw Error(`Not supported compoents ${u}`)}},o=ty("input",r[0].dataType,r[0].dims,u),l=t_("output",r[0].dataType,a,u);return`
  ...
  ${r.mainStart()}
    ...
    `,u=ty("x",r.dataType,r.dims.length),[l,d,p,c,h]=ax(s,n);return l.push(...td(r.dims,s)),{name:t,shaderCache:{hint:`${a.cacheKey};${p};${c};${h}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(tt.size(s)/64)},programUniforms:l}),getShaderSource:t=>aS(t,u,r.dims.length,s.length,n,o,"",10===r.dataType?-65504:-1e5,d,p,c,h)}},aB=(t,r)=>{av(t.inputs),t.compute(aR("MaxPool",t.inputs[0],!1,r))},aN=t=>{let r,i=t.storage_order,a=t.dilations,n=aT(t);if(0!==i)throw Error("column major storage order is not yet supported for MaxPool");if(0!==n.ceilMode)throw Error("using ceil() in shape computation is not yet supported for MaxPool");let s={storageOrder:i,dilations:a,...n,cacheKey:""};return{...s,cacheKey:(r=s,`${ak(r)};${r.storageOrder};${r.dilations}`)}},aM=t=>{let r=t.format;return{format:r,...az,cacheKey:r}},aD=(t,r)=>{av(t.inputs),t.compute(aR("GlobalMaxPool",t.inputs[0],!0,r))}}),sr=U(()=>{nm(),nw(),nv(),nx(),aP=(t,r)=>{var i,a;let n,s,o,u,l,d,p,c,h,f,m,g,y,_,$,b,v,w,x,S,k,T,I;((t,r)=>{if(t.length<2||t.length>3)throw Error("DequantizeLinear requires 2 or 3 inputs.");if(3===t.length&&t[1].dims===t[2].dims)throw Error("x-scale and x-zero-point must have the same shape.");if(3===t.length&&t[0].dataType!==t[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(6===t[0].dataType&&t.length>2)throw Error("In the case of dequantizing int32 there is no zero point.");if(0!==t[1].dims.length&&1!==t[1].dims.length&&t[1].dims.length!==t[0].dims.length)throw Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(t.length>2){if(t[0].dataType!==t[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(t[1].dims.length!==t[2].dims.length)throw Error("scale and zero-point inputs must have the same rank.");if(!t[1].dims.map((r,i)=>r===t[2].dims[i]).reduce((t,r)=>t&&r,!0))throw Error("scale and zero-point inputs must have the same shape.")}if(r.blockSize>0){if(0===t[1].dims.length||1===t[1].dims.length&&1===t[1].dims[0])throw Error("blockSize must be set only for block quantization.");if(!t[1].dims.map((i,a)=>a===r.axis||i===t[0].dims[a]).reduce((t,r)=>t&&r,!0))throw Error("For block qunatization, scale input shape to match the input shape except for the axis");if(t[1].dims.length!==t[0].dims.length)throw Error("For block qunatization the scale input rank must be the same as the x rank.");let i=t[0].dims[r.axis],a=t[1].dims[r.axis];if(r.blockSize<Math.ceil(i/a)||r.blockSize>Math.ceil(i/(a-1)-1))throw Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}})(t.inputs,r),t.compute((i=t.inputs,a=r,n=tt.normalizeAxis(a.axis,i[0].dims.length),o=3===(s=i[0].dataType),u=i[0].dims,l=i[1].dataType,d=tt.size(u),c=(p=3===s||2===s)?[Math.ceil(tt.size(i[0].dims)/4)]:i[0].dims,h=i[1].dims,m=(f=i.length>2?i[2]:void 0)?p?[Math.ceil(tt.size(f.dims)/4)]:f.dims:void 0,y=!1==(g=0===h.length||1===h.length&&1===h[0])&&1===h.length,_=tp(d),b=($=g&&(!p||4===_))?_:1,v=ty("input",p?12:s,c.length,$&&!p?_:1),w=ty("scale",l,h.length),x=f?ty("zero_point",p?12:s,m.length):void 0,S=t_("output",l,u.length,b),k=[v,w],x&&k.push(x),T=[c,h],f&&T.push(m),I=[{type:12,data:d/b},{type:12,data:n},{type:12,data:a.blockSize},...td(...T,u)],{name:"DequantizeLinear",shaderCache:{hint:a.cacheKey,inputDependencies:x?["rank","rank","rank"]:["rank","rank"]},getShaderSource:t=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:u,dataType:l}],dispatchGroup:{x:Math.ceil(d/b/64),y:1,z:1},programUniforms:I})}))},aU=t=>e7({axis:t.axis,blockSize:t.blockSize})}),si=U(()=>{eo(),nm(),nx(),aW=t=>{var r,i,a,n;let s,o,u,l=0,p=0,c=0;6===t.inputs[0].dataType?(l=t.inputs[0].getInt32Array()[0],p=t.inputs[1].getInt32Array()[0],c=t.inputs[2].getInt32Array()[0]):1===t.inputs[0].dataType&&(l=t.inputs[0].getFloat32Array()[0],p=t.inputs[1].getFloat32Array()[0],c=t.inputs[2].getFloat32Array()[0]),d.webgpu.validateInputContent&&((t,r,i)=>{if(t===r||t<r&&i<0||t>r&&i>0)throw Error("Range these inputs' contents are invalid.")})(l,p,c),t.compute((r=l,i=p,a=c,n=t.inputs[0].dataType,o=[s=Math.abs(Math.ceil((i-r)/a))],u=[{type:12,data:s},{type:n,data:r},{type:n,data:a},...td(o)],{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:t=>{let r=t_("output",n,o.length),i=r.type.value;return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${((t,r,i,a)=>{if("none"!==t&&"i32"!==a&&"u32"!==a&&"f32"!==a)throw Error(`Input ${a} is not supported with reduction ${t}.`);let n=`{
      ...
      }`}}),{inputs:[t.inputs[1],t.inputs[2]],outputs:[]})}}),sn=U(()=>{nm(),nw(),nv(),nx(),aV=(t,r,i,a)=>`
...
`:"",aH=(t,r)=>{var i,a,n,s,o,u,l,d,p,c,h,f;let m,g,y,_,$,b,v,w,x,S,k,T,I,C,E,z,A=[],O=[],R=[],B=new Uint32Array(m=t.customDataBuffer,m.byteOffset,1)[0];if(0!==r.antialias)throw Error("Only default value (0) for Antialias attribute is supported");((t,r,i,a,n,s)=>{let[o,u,l]=i>10?[1,2,3]:[-1,t.length>1?1:-1,-1],d=t[0].dims.length;if(o>0&&t.length>o&&t[o].dims.length>0)t[o].getFloat32Array().forEach(t=>s.push(t));else if("tf_crop_and_resize"===r.coordinateTransformMode)throw Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&t.length>u&&1===t[u].dims.length&&t[u].dims[0]>0){var p,c,h;let n;if(t[u].getFloat32Array().forEach(t=>a.push(t)),0!==a.length&&a.length!==d&&i>=18&&a.length!==r.axes.length)throw Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");((t,r)=>{if(t.every(t=>t>0||(()=>{throw Error("Resize requires scales input values to be positive")})),t.length>0){if("linear"===r.mode){if(2!==t.length&&3!==t.length&&(4!==t.length||1!==t[0]||1!==t[1])&&(4!==t.length||1!==t[0]||1!==t[3])&&(5!==t.length||1!==t[0]||1!==t[1]))throw Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
     ...
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${i} { `+(()=>{switch(r){case"asymmetric":return`
          if (xScale < 1.0 || floor(xScale) != xScale) {
            ...
            ${aV("xResized","lengthOriginal","lengthResized",i)}
          }
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                    ...
                    ${aV("xResized","lengthOriginal - 1","lengthResized - 1",i)}
...
`}
      ...
      }`}},{inputs:[p],outputs:[d?-1:0]})[0],d&&i.compute(tS(x,c),{inputs:[x]})},a0=t=>e7({axis:t.axis})}),sd=U(()=>{nm(),nw(),nx(),a1=t=>Array.from(t.getBigInt64Array(),Number),a2=t=>{var r;let i,a,n,s,o,u,l;(t=>{if(!t||2!==t.length)throw Error("Tile requires 2 inputs.");if(1!==t[0].dataType&&10!==t[0].dataType&&6!==t[0].dataType&&12!==t[0].dataType)throw Error("Tile only support float, float16, int32, and uint32 data types");if(7!==t[1].dataType)throw Error("Tile `repeats` input should be of int64 data type");if(1!==t[1].dims.length)throw Error("Tile `repeats` input should be 1-D");if(a1(t[1]).length!==t[0].dims.length)throw Error("Tile `repeats` input should have same number of elements as rank of input data tensor")})(t.inputs),t.compute((i=(r=t.inputs)[0].dims,n=((t,r)=>{let i=[];for(let a=0;a<t.length;++a)i.push(t[a]*r[a]);return i})(i,a=(void 0)??a1(r[1])),s=tt.size(n),o=r[0].dataType,u=ty("input",o,i.length),l=t_("output",o,n.length),{name:"Tile",shaderCache:{hint:`${a}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:n,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:[{type:12,data:s},...td(r[0].dims,n)]}),getShaderSource:t=>`
    ...
    }`}),{inputs:[0]})}}),sp=U(()=>{nm(),nw(),nx(),a3=t=>{t.compute((t=>{let r=t[1].dims,i=t[2].dims,a=t[0].dims,n=t[1].dataType,s=!(tt.areEqual(r,i)&&tt.areEqual(i,a)),o=r,u=tt.size(r);if(s){let t=te.calcShape(te.calcShape(r,i,!1),a,!1);if(!t)throw Error("Can't perform where op on the given tensors");o=t,u=tt.size(o)}let l=Math.ceil(u/4);return{name:"Where",shaderCache:{inputDependencies:["rank","rank","rank"]},getShaderSource:r=>((t,r,i,a,n)=>{let s=t_("output_data",n,i.length,4),o=ty("a_data",r[1].dataType,r[1].dims.length,4),u=ty("b_data",r[2].dataType,r[2].dims.length,4),l=ty("c_data",r[0].dataType,r[0].dims.length,4),d,p=(t,r,i)=>`select(${r}, ${t}, ${i})`;if(a){let t=function(t,r){let i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",a=`a_data[index_a${r}][component_a${r}]`,n=`b_data[index_b${r}][component_b${r}]`,d=`bool(c_data[index_c${r}] & (0xffu << (component_c${r} * 8)))`;return`
